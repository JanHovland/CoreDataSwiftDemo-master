    ...
    func updateData(){
        ...
        do
        {
            let test = try managedContext.fetch(fetchRequest)
                ...
                // .fetch merker posten for henting, men henter ikke fra CoreData
                // .save henter fra CoreData
     ...
     func deleteData(){
        ...
        do
        {
            ...
            if test.count > 0 {
                ...
                // .delete merker posten for sletting, men oppdaterer ikke CoreData
                // .save oppdaterer CoreData
                ...
                print("Fant ingen post som kan slettes!")
            }
        }
        catch
        {
